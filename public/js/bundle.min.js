if (
  (!(function (n, t) {
    ...
    function cr(n, t, r) {
      var u;
      try {
        n && i.isFunction((u = n.promise))
          ? u.call(n).done(t).fail(r)
          : n && i.isFunction((u = n.then))
          ? u.call(n, t, r)
          : t.call(void 0, n);
      } catch (n) {
        r.call(void 0, n);
    ...
    function iu(n, t) {
      return i.nodeName(n, "table") &&
        ...
        ? n.getElementsByTagName("tbody")[0] || n
        : n;
    }
    function le(n) {
    ...
    function it(n, t, u, e) {
      ...
      if (
        v &&
        ((l = gr(t, n[0].ownerDocument, !1, n, e)),
        (p = l.firstChild),
        1 === l.childNodes.length && (l = p),
        p || e)
      ) {
        for (c = i.map(o(l, "script"), le), a = c.length; h < v; h++)
          (s = l),
            h !== k &&
        ...
        if (a)
          for (
            w = c[c.length - 1].ownerDocument, i.map(c, ae), h = 0;
            h < a;
            h++
          )
            (s = c[h]),
    ...
    function uu(n, t, r) {
      for (var u, e = t ? i.filter(t, n) : n, f = 0; null != (u = e[f]); f++)
        r || 1 !== u.nodeType || i.cleanData(o(u)),
          u.parentNode &&
            (r && i.contains(u.ownerDocument, u) && oi(o(u, "script")),
    ...
    function au(n, t, r, u, f) {
      for (
        var o = 0,
          e = r === (u ? "border" : "content") ? 4 : "width" === t ? 1 : 0;
        e < 4;
        e += 2
      )
    ...
    function vu(n, t, r) {
      ...
      if (
        (n.getClientRects().length && (u = n.getBoundingClientRect()[t]),
        u <= 0 || null == u)
      ) {
        if (
          ((u = lt(n, t, e)),
      ...
      if (((s = !i.isEmptyObject(t)), s || !i.isEmptyObject(p))) {
        ...
        for (f in p)
          s ||
            ...
            (s = ku(a ? e[f] : 0, f, v)),
            f in e ||
              ((e[f] = s.start), a && ((s.end = s.start), (s.start = 0)));
      }
    }
    function be(n, t) {
      var r, f, e, u, o;
    ...
    v = (function (n) {
                  ...
                  if ("undefined" != typeof t.getElementById && h) {
                    ...
                    if (r) {
                      ...
                      for (f = t.getElementsByName(n), u = 0; (r = f[u++]); )
                        if (
                          ((i = r.getAttributeNode("id")), i && i.value === n)
                        )
                          return [r];
                    }
                    return [];
      ...
      u.attr = function (n, r) {
        ...
        var f = t.attrHandle[r.toLowerCase()],
          u =
            f && gi.call(t.attrHandle, r.toLowerCase()) ? f(n, r, !h) : void 0;
        return void 0 !== u
          ? u
          : e.attributes || !h
          ? n.getAttribute(r)
      ...
      var f,
        ...
        s = {
          add: function () {
            return (
              t &&
                (r && !f && ((u = t.length - 1), o.push(r)),
                (function e(r) {
                  i.each(r, function (r, u) {
                    i.isFunction(u)
                      ? (n.unique && s.has(u)) || t.push(u)
                      : u && u.length && "string" !== i.type(u) && e(u);
                  });
                })(arguments),
                r && !f && c()),
              this
    ...
    i.extend({
                  ...
                  var s = this,
                    ...
                    l = function () {
                      ...
                      if (!(t < e)) {
                        ...
                        i.isFunction(c)
                          ? f
                            ? c.call(n, o(e, r, g, f), o(e, r, pt, f))
                            : (e++,
                              c.call(
                                n,
                                o(e, r, g, f),
                                o(e, r, pt, f),
                                o(e, r, g, r.notifyWith)
                              ))
                          : (u !== g && ((s = void 0), (h = [n])),
                            (f || r.resolveWith)(s, h));
                      }
      ...
      when: function (n) {
        ...
        if (
          f <= 1 &&
          (cr(n, r.done(o(t)).resolve, r.reject),
          ...
          if (
            ...
            for (o = h.length; o--; )
              h[o] &&
                ((f = h[o].name),
                0 === f.indexOf("data-") &&
                  ((f = i.camelCase(f.slice(5))), ar(u, f, s[f])));
    ...
    i.event = {
      ...
      handlers: function (n, t) {
        ...
        return (
          (r = this),
          h < t.length && c.push({ elem: r, handlers: t.slice(h) }),
          c
        );
      },
    ...
    i.each(
      {
        ...
        which: function (n) {
          var t = n.button;
          return null == n.which && ue.test(n.type)
            ? null != n.charCode
              ? n.charCode
              : n.keyCode
            : !n.which && void 0 !== t && fe.test(n.type)
            ? 1 & t
              ? 1
              : 2 & t
              ? 3
    ...
    i.extend({
      ...
      style: function (n, t, r, u) {
        if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
          var e,
            ...
            c = n.style;
          return (
            (t = i.cssProps[s] || (i.cssProps[s] = cu(s) || s)),
      ...
      css: function (n, t, r, u) {
        var f,
          ...
          e = i.camelCase(t);
        return (
          (t = i.cssProps[e] || (i.cssProps[e] = cu(e) || e)),
    ...
    i.each(["height", "width"], function (n, t) {
      i.cssHooks[t] = {
        get: function (n, r, u) {
          if (r)
            return !ye.test(i.css(n, "display")) ||
        ...
        set: function (n, r, u) {
          var f,
            ...
            o =
              u &&
              au(n, t, u, "border-box" === i.css(n, "boxSizing", !1, e), e);
          return (
            o &&
              (f = ct.exec(r)) &&
              "px" !== (f[3] || "px") &&
      ...
      stop: function (n, t, u) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (t in e) e[t] && e[t].stop && pu.test(t) && f(e[t]);
            for (t = o.length; t--; )
              o[t].elem !== this ||
                (null != n && o[t].queue !== n) ||
    ...
    i.fx.start = function () {
      ut ||
        (ut = n.requestAnimationFrame
          ? n.requestAnimationFrame(wu)
          : n.setInterval(i.fx.tick, i.fx.interval));
    };
    i.fx.stop = function () {
          ...
          return "undefined" == typeof n.getAttribute
            ...
            : ((1 === e && i.isXMLDoc(n)) ||
                (f =
                  ...
                  (i.expr.match.bool.test(t) ? du : void 0)),
              void 0 !== r
                ? null === r
      ...
      propHooks: {
        tabIndex: {
          get: function (n) {
            ...
            return t
              ? parseInt(t, 10)
              : gu.test(n.nodeName) || (nf.test(n.nodeName) && n.href)
              ? 0
              : -1;
          },
        },
        ...
        return arguments.length
          ...
          ? ((t = i.valHooks[u.type] || i.valHooks[u.nodeName.toLowerCase()]),
            t && "get" in t && void 0 !== (r = t.get(u, "value"))
              ? r
              : ((r = u.value),
                "string" == typeof r ? r.replace(tf, "") : null == r ? "" : r))
          : void 0;
      },
    });
    i.extend({
      ...
      trigger: function (t, f, e, o) {
        ...
        if (
          ...
          if (!o && !l.noBubble && !i.isWindow(e)) {
            for (
              b = l.delegateType || h, ci.test(b + h) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              p.push(s), (c = s);
        ...
        return this.map(function () {
          ...
          .map(function (n, t) {
            ...
            return null == r
              ...
              : i.isArray(r)
              ? i.map(r, function (n) {
                  return { name: t.name, value: n.replace(uf, "\r\n") };
                })
    ...
    return (
        ...
        ajax: function (t, r) {
          ...
          if (
            ...
            try {
              ...
              l.href = l.href;
              f.crossDomain =
                yi.protocol + "//" + yi.host != l.protocol + "//" + l.host;
            } catch (et) {
              f.crossDomain = !0;
            }
          }
          ...
          f.hasContent
            ? f.data &&
              ...
              (f.data = f.data.replace(no, "+"))
            : ((p = f.url.slice(o.length)),
              f.data &&
                ((o += (li.test(o) ? "&" : "?") + f.data), delete f.data),
              f.cache === !1 &&
                ((o = o.replace(io, "$1")),
                (p = (li.test(o) ? "&" : "?") + "_=" + rf++ + p)),
              (f.url = o + p));
          ...
          return (
            (f = t.jsonpCallback =
              i.isFunction(t.jsonpCallback)
                ...
                : t.jsonpCallback),
            s
              ? (t[s] = t[s].replace(ii, "$1" + f))
              : t.jsonp !== !1 &&
                (t.url += (li.test(t.url) ? "&" : "?") + t.jsonp + "=" + f),
      ...
      (i.fn.load = function (n, t, r) {
        var u,
          ...
          e = n.indexOf(" ");
        return (
          e > -1 && ((u = b(n.slice(e))), (n = n.slice(0, e))),
          i.isFunction(t)
            ? ((r = t), (t = void 0))
      ...
      i.each(["top", "left"], function (n, t) {
        i.cssHooks[t] = eu(f.pixelPosition, function (n, r) {
          if (r)
            return (r = lt(n, t)), hi.test(r) ? i(n).position()[t] + "px" : r;
        });
      }),
      ...
      (i.noConflict = function (t) {
        return (
          n.$ === i && (n.$ = af), t && n.jQuery === i && (n.jQuery = lf), i
        );
      }),
      t || (n.jQuery = n.$ = i),
      i
    ...
    setTimeout(
      n.proxy(function () {
        ...
        t == "loadingText"
          ...
          : this.isLoading &&
            ((this.isLoading = !1), r.removeClass(i).removeAttr(i).prop(i, !1));
      }, this),
      0
    );
  };
...
+(function (n) {
  ...
  t.prototype.backdrop = function (i) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      if (
        (r && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), !i)
      )
        return;
      r
        ? this.$backdrop
...
+(function (n) {
  ...
  t.prototype.enter = function (t) {
    ...
    if (
      ...
      t instanceof n.Event &&
        (i.inState[t.type == "focusin" ? "focus" : "hover"] = !0),
  ...
  t.prototype.leave = function (t) {
    ...
    if (
      (i ||
        ...
        n(t.currentTarget).data("bs." + this.type, i)),
      t instanceof n.Event &&
        (i.inState[t.type == "focusout" ? "focus" : "hover"] = !1),
      !i.isInStateTrue())
    ) {
      if (
        (clearTimeout(i.timeout),
  ...
  t.prototype.tip = function () {
    if (
      !this.$tip &&
      ((this.$tip = n(this.options.template)), this.$tip.length != 1)
    )
      throw new Error(
        this.type +
...
+(function (n) {
  ...
  t.prototype.setContent = function () {
    ...
    n.find(".popover-content")
      ...
      .detach()
      .end()
      [this.options.html ? (typeof t == "string" ? "html" : "append") : "text"](
        t
      );
  ...
  t.prototype.getContent = function () {
    ...
    return (
      t.attr("data-content") ||
      (typeof n.content == "function" ? n.content.call(t[0]) : n.content)
    );
  };
  t.prototype.arrow = function () {
...
+(function (n) {
  ...
  t.prototype.activate = function (i, r, u) {
    ...
    f.length && e
      ? f.one("bsTransitionEnd", o).emulateTransitionEnd(t.TRANSITION_DURATION)
      : o();
    f.removeClass("in");
  };
  u = n.fn.tab;
  ...
  (function (n) {
    ...
    var o = 0,
      f = (function () {
        var i = r.userAgent,
          ...
          t;
        return i.search(u) > 0 &&
          ((t = u.exec(i).toString()), (t = t.split(" ")[1]), t < 9)
          ? (n("html").addClass("lt-ie9"), !0)
          : !1;
      })();
          ...
          (u = function () {
            ...
            return this instanceof u
              ? ((e = function () {}),
                ...
                (o = new e()),
                (f = t.apply(o, r.concat(i.call(arguments)))),
                Object(f) === f)
                ? f
                : o
              : t.apply(n, r.concat(i.call(arguments)));
          }),
          u
        );
      });
    Array.prototype.indexOf ||
      (Array.prototype.indexOf = function (n, t) {
        ...
        if (
          ((f = Object(this)), (u = f.length >>> 0), u === 0) ||
          ((i = +t || 0), Math.abs(i) === Infinity && (i = 0), i >= u)
        )
          return -1;
    ...
    var s =
      ...
      e = function (r, f, e) {
        ...
        o[0].nodeName !== "INPUT" &&
          console &&
          console.warn &&
          console.warn("Base element should be <input>!", o[0]);
        h = {
          type: o.data("type"),
          min: o.data("min"),
          max: o.data("max"),
        ...
        for (l in h)
          h.hasOwnProperty(l) && (h[l] === u || h[l] === "") && delete h[l];
        s !== u &&
          s !== "" &&
          ((s = s.split(
            h.input_values_separator || f.input_values_separator || ";"
          )),
          s[0] && s[0] == +s[0] && (s[0] = +s[0]),
          s[1] && s[1] == +s[1] && (s[1] = +s[1]),
          f && f.values && f.values.length
            ? ((c.from = s[0] && f.values.indexOf(s[0])),
              (c.to = s[1] && f.values.indexOf(s[1])))
            : ((c.from = s[0] && +s[0]), (c.to = s[1] && +s[1])));
        n.extend(c, f);
        n.extend(c, h);
        this.options = c;
        this.update_check = {};
    ...
    e.prototype = {
      ...
      setTopHandler: function () {
        ...
        r > i && t === n
          ...
          : t < n && this.$cache.s_to.addClass("type_last");
      },
      ...
      pointerUp: function (t) {
        if (this.current_plugin === this.plugin_count) {
          ...
          (n.contains(this.$cache.cont[0], t.target) || this.dragging) &&
            this.callOnFinish();
          this.dragging = !1;
        }
      },
          ...
          if (this.options.type === "single")
            e
              ...
              : ((i = this._prettify(this.result.from)),
                (n = this.decorate(i, this.result.from)),
                this.$cache.single.html(n)),
              this.calcLabels(),
            ...
            e
              ? (this.options.decorate_both
                  ? ((n = this.decorate(t[this.result.from])),
                    (n += this.options.values_separator),
                    (n += this.decorate(t[this.result.to])))
                  : (n = this.decorate(
                      t[this.result.from] +
              ...
              : ((i = this._prettify(this.result.from)),
                ...
                this.options.decorate_both
                  ? ((n = this.decorate(i, this.result.from)),
                    (n += this.options.values_separator),
                    (n += this.decorate(f, this.result.to)))
                  : (n = this.decorate(
                      i + this.options.values_separator + f,
                      this.result.to
                    )),
            ...
            this.labels.p_to_left
              ...
              : ((this.$cache.from[0].style.visibility = "visible"),
                ...
                (this.$cache.single[0].style.visibility = "hidden"));
            this.$cache.min[0].style.visibility =
              c < this.labels.p_min + 1 ? "hidden" : "visible";
            this.$cache.max[0].style.visibility =
              s > 99 - this.labels.p_max ? "hidden" : "visible";
          }
      },
      drawShadow: function () {
        var n = this.options,
      ...
      callOnStart: function () {
        if (
          (this.writeToInput(),
          this.options.onStart && typeof this.options.onStart == "function")
        )
      ...
      callOnFinish: function () {
        if (
          (this.writeToInput(),
          this.options.onFinish && typeof this.options.onFinish == "function")
        )
          if (this.options.scope)
      ...
      callOnUpdate: function () {
        if (
          (this.writeToInput(),
          this.options.onUpdate && typeof this.options.onUpdate == "function")
        )
          if (this.options.scope)
      ...
      convertToPercent: function (n, t) {
        var i = this.options.max - this.options.min,
          ...
          u;
        return i
          ? ((r = t ? n : n - this.options.min), (u = r / f), this.toFixed(u))
      ...
      convertToValue: function (n) {
        ...
        return n === 0
          ...
          : (c && ((u = c.length), (e = u)),
            ...
            r < this.options.min
              ? (r = this.options.min)
              : r > this.options.max && (r = this.options.max),
            r);
      },
      ...
      checkMinInterval: function (n, t, i) {
        ...
        return u.min_interval
          ? ((r = this.convertToValue(n)),
            (f = this.convertToValue(t)),
            i === "from"
              ? f - r < u.min_interval && (r = f - u.min_interval)
              : r - f < u.min_interval && (r = f + u.min_interval),
            this.convertToPercent(r))
          : n;
      },
      checkMaxInterval: function (n, t, i) {
        ...
        return u.max_interval
          ? ((r = this.convertToValue(n)),
            (f = this.convertToValue(t)),
            i === "from"
              ? f - r > u.max_interval && (r = f - u.max_interval)
              : r - f > u.max_interval && (r = f + u.max_interval),
            this.convertToPercent(r))
          : n;
      },
      checkDiapason: function (n, t, i) {
        var r = this.convertToValue(n),
          u = this.options;
        return (
          typeof t != "number" && (t = u.min),
          typeof i != "number" && (i = u.max),
          r < t && (r = t),
          r > i && (r = i),
          this.convertToPercent(r)
        );
      ...
      _prettify: function (n) {
        return this.options.prettify_enabled
          ? this.options.prettify && typeof this.options.prettify == "function"
            ? this.options.prettify(n)
            : this.prettify(n)
          : n;
      },
      prettify: function (n) {
      ...
      checkEdges: function (n, t) {
        return this.options.force_edges
          ? (n < 0 ? (n = 0) : n > 100 - t && (n = 100 - t), this.toFixed(n))
          : this.toFixed(n);
      },
      validate: function () {
        var n = this.options,
        ...
        if (
          ...
          for (
            ...
            (i = +u[r]),
              isNaN(i) ? (i = u[r]) : ((u[r] = i), (i = this._prettify(i))),
              n.p_values.push(i);
        ...
        n.type === "single"
          ...
          : (n.from < n.min && (n.from = n.min),
            ...
            this.update_check.from &&
              (this.update_check.from !== n.from &&
                n.from > n.to &&
                (n.from = n.to),
              this.update_check.to !== n.to &&
                n.to < n.from &&
                (n.to = n.from)),
            n.from > n.to && (n.from = n.to),
            n.to < n.from && (n.to = n.from));
        (typeof n.step != "number" || isNaN(n.step) || !n.step || n.step < 0) &&
          (n.step = 1);
        typeof n.from_min == "number" &&
          n.from < n.from_min &&
          (n.from = n.from_min);
        typeof n.from_max == "number" &&
          n.from > n.from_max &&
          (n.from = n.from_max);
        typeof n.to_min == "number" && n.to < n.to_min && (n.to = n.to_min);
        typeof n.to_max == "number" && n.from > n.to_max && (n.to = n.to_max);
        t &&
          (t.min !== n.min && (t.min = n.min),
          t.max !== n.max && (t.max = n.max),
          (t.from < t.min || t.from > t.max) && (t.from = n.from),
          (t.to < t.min || t.to > t.max) && (t.to = n.to));
        (typeof n.min_interval != "number" ||
          isNaN(n.min_interval) ||
          !n.min_interval ||
          n.min_interval < 0) &&
          (n.min_interval = 0);
        (typeof n.max_interval != "number" ||
      ...
      decorate: function (n, t) {
        ...
        return (
          ...
          (r += n),
          i.max_postfix &&
            (i.values.length && n === i.p_values[i.max]
              ? ((r += i.max_postfix), i.postfix && (r += " "))
              : t === i.max && ((r += i.max_postfix), i.postfix && (r += " "))),
        ...
        if (this.options.grid) {
          ...
          for (
            this.calcGridMargin(),
              n.grid_snap
                ? h > 50
                  ? ((i = 50 / n.step), (u = this.toFixed(n.step / 0.5)))
                  : ((i = h / n.step), (u = this.toFixed(n.step / (h / 100))))
                : (u = this.toFixed(100 / i)),
              i > 4 && (f = 3),
              i > 7 && (f = 2),
              i > 14 && (f = 1),
              i > 28 && (f = 0),
      ...
      cacheGridLabels: function () {
        for (var t, i = this.coords.big_num, n = 0; n < i; n++)
          (t = this.$cache.grid.find(".js-grid-text-" + n)),
      ...
      calcGridLabels: function () {
        for (var u, i = [], r = [], t = this.coords.big_num, n = 0; n < t; n++)
          (this.coords.big_w[n] = this.$cache.grid_labels[n].outerWidth(!1)),
            (this.coords.big_p[n] = this.toFixed(
              (this.coords.big_w[n] / this.coords.w_rs) * 100
            )),
        ...
        for (
          this.options.force_edges &&
            (i[0] < -this.coords.grid_gap &&
              ((i[0] = -this.coords.grid_gap),
              (r[0] = this.toFixed(i[0] + this.coords.big_p[0])),
              (this.coords.big_x[0] = this.coords.grid_gap)),
            r[t - 1] > 100 + this.coords.grid_gap &&
              ((r[t - 1] = 100 + this.coords.grid_gap),
              (i[t - 1] = this.toFixed(r[t - 1] - this.coords.big_p[t - 1])),
              (this.coords.big_x[t - 1] = this.toFixed(
                this.coords.big_p[t - 1] - this.coords.grid_gap
              )))),
          ...
          (u = this.$cache.grid_labels[n][0]),
            this.coords.big_x[n] !== Number.POSITIVE_INFINITY &&
              (u.style.marginLeft = -this.coords.big_x[n] + "%");
      },
      ...
      destroy: function () {
        this.input &&
          ...
          n.data(this.input, "ionRangeSlider", null),
          this.remove(),
          (this.input = null),
          (this.options = null));
      },
    ...
    (n.fn.ionRangeSlider = function (t) {
      return this.each(function () {
        n.data(this, "ionRangeSlider") ||
          n.data(this, "ionRangeSlider", new e(this, t, o++));
      });
    }),
      (function () {
        for (
          var r = 0, t = ["ms", "moz", "webkit", "o"], n = 0;
          n < t.length && !i.requestAnimationFrame;
          ++n
        )
          (i.requestAnimationFrame = i[t[n] + "RequestAnimationFrame"]),
            (i.cancelAnimationFrame =
              i[t[n] + "CancelAnimationFrame"] ||
              i[t[n] + "CancelRequestAnimationFrame"]);
  ...
  (function (n) {
    ...
    var h = "Close",
      ...
      e = function (t, i, r, u) {
        ...
        return (
          (f.className = "mfp-" + t),
          r && (f.innerHTML = r),
          u ? i && i.appendChild(f) : ((f = n(f)), i && f.appendTo(i)),
          f
        );
      },
      i = function (i, r) {
        ...
        t.st.callbacks &&
          ...
          t.st.callbacks[i] &&
            t.st.callbacks[i].apply(t, n.isArray(r) ? r : [r]));
      },
      st = function (i) {
        return (
          (i === kt && t.currTemplate.closeBtn) ||
            ((t.currTemplate.closeBtn = n(
      ...
      ht = function () {
        n.magnificPopup.instance ||
          ((t = new w()), t.init(), (n.magnificPopup.instance = t));
      },
      ri = function () {
    ...
    w.prototype = {
      ...
      open: function (s) {
        ...
        if (s.isObj === !1) {
          for (
            t.items = s.items.toArray(), t.index = 0, w = s.items, h = 0;
            h < w.length;
            h++
          )
        ...
        for (
          t.types = [],
            ...
            s.key
              ? (t.popupsCache[s.key] || (t.popupsCache[s.key] = {}),
                (t.currTemplate = t.popupsCache[s.key]))
              : (t.currTemplate = {}),
            ...
            t.st.preloader &&
              (t.preloader = e("preloader", t.container, t.st.tLoading)),
        ...
        if (
          ...
          t.fixedContentPos
            ...
            : t.wrap.css({ top: f.scrollTop(), position: "absolute" }),
          (t.st.fixedBgPos !== !1 &&
        ...
        return (
          ...
          t.fixedContentPos &&
            t._hasScrollBar(k) &&
            ((d = t._getScrollbarSize()), d && (v.marginRight = d)),
          t.fixedContentPos &&
            (t.isIE7
      ...
      appendContent: function (n, r) {
        t.content = n;
        n
          ? t.st.showCloseBtn && t.st.closeBtnInside && t.currTemplate[r] === !0
            ? t.content.find(".mfp-close").length || t.content.append(st())
            : (t.content = n)
          : (t.content = "");
        i(ii);
      ...
      addGroup: function (n, i) {
        var u = function (r) {
          ...
          r;
        if (
          (i || (i = {}), (r = "click.magnificPopup"), (i.mainEl = n), i.items)
        ) {
          i.isObj = !0;
          n.off(r).on(r, u);
      ...
      _openClick: function (i, r, u) {
        var o =
            u.midClick !== undefined
              ? u.midClick
              : n.magnificPopup.defaults.midClick,
          e;
        if (
          o ||
          !(i.which === 2 || i.ctrlKey || i.metaKey || i.altKey || i.shiftKey)
        ) {
          if (
            ((e =
              u.disableOn !== undefined
                ? u.disableOn
                : n.magnificPopup.defaults.disableOn),
            e)
          )
            if (n.isFunction(e)) {
            ...
            ? ((f = t.st.inline),
              ...
              u.length
                ? ((o = u[0].parentNode),
                  o &&
                    o.tagName &&
                    (d || ((a = f.hiddenClass), (d = e(a)), (a = "mfp-" + a)),
          ...
          var u = n.extend(
            {
              ...
              error: function () {
                ...
                t.updateStatus(
                  "error",
                  t.st.ajax.tError.replace("%url%", r.src)
                );
              },
            },
            t.st.ajax.settings
    ...
    n.magnificPopup.registerModule("image", {
      ...
      proto: {
        initImage: function () {
          ...
          t.types.push("image");
          r(rt + e, function () {
            t.currItem.type === "image" &&
              i.cursor &&
              n(document.body).addClass(i.cursor);
          });
          r(h + e, function () {
        ...
        resizeImage: function () {
          ...
          n &&
            n.img &&
            t.st.image.verticalFit &&
            ((i = 0),
            t.isLowIE &&
              (i =
                parseInt(n.img.css("padding-top"), 10) +
                parseInt(n.img.css("padding-bottom"), 10)),
        ...
        getImage: function (r, u) {
            ...
            o = function () {
              r &&
                (r.img[0].complete
                  ? (r.img.off(".mfploader"),
                    r === t.currItem &&
                      (t._onImageHasSize(r), t.updateStatus("ready")),
                    (r.hasSize = !0),
                    (r.loaded = !0),
                    i("ImageLoadComplete"))
          ...
          return (l.length &&
            ...
            (f.className = "mfp-img"),
            r.el &&
              r.el.find("img").length &&
              (f.alt = r.el.find("img").attr("alt")),
            ...
            ? (s && clearInterval(s),
              r.loadError
                ? (u.addClass("mfp-loading"),
                  t.updateStatus("error", c.tError.replace("%url%", r.src)))
                : (u.removeClass("mfp-loading"), t.updateStatus("ready")),
              u)
            : (t.updateStatus("loading"),
              (r.loading = !0),
              r.hasSize ||
    ...
    ni = function () {
      return (
        at === undefined &&
          (at = document.createElement("p").style.MozTransform !== undefined),
        at
      );
    };
    ...
    n.magnificPopup.registerModule("gallery", {
      ...
      proto: {
        initGallery: function () {
          ...
          r("BuildControls" + i, function () {
            if (t.items.length > 1 && u.arrows && !t.arrowLeft) {
              var o = u.arrowMarkup,
                i = (t.arrowLeft = n(
                  o.replace(/%title%/gi, u.tPrev).replace(/%dir%/gi, "left")
                ).addClass(ft)),
                r = (t.arrowRight = n(
                  o.replace(/%title%/gi, u.tNext).replace(/%dir%/gi, "right")
                ).addClass(ft)),
        ...
        preloadNearbyImages: function () {
          for (
            var i = t.st.gallery.preload,
              r = Math.min(i[0], t.items.length),
              u = Math.min(i[1], t.items.length),
              n = 1;
            n <= (t.direction ? u : r);
            n++
          )
            ...
            if (i)
              l.on("touchstart" + t, function (n) {
                ...
                f.on("touchmove" + t, function (n) {
                  ...
                  c = o.length;
                  o = o[0];
                  (Math.abs(o.clientX - v) > 10 ||
                    Math.abs(o.clientY - y) > 10) &&
                    ((h = !0), r());
  ...
  (function (n, t, i) {
    var r = {
      ...
      loadContent: function () {
        ...
        var t = this,
          i;
        typeof t.options.beforeInit == "function" &&
          t.options.beforeInit.apply(this, [t.$elem]);
        typeof t.options.jsonPath == "string"
          ? ((i = t.options.jsonPath), n.getJSON(i, r))
          : t.logIn();
      },
      logIn: function () {
        var n = this;
      ...
      onStartup: function () {
        ...
        n.stopOnHover();
        n.owlStatus();
        n.options.transitionStyle !== !1 &&
          n.transitionTypes(n.options.transitionStyle);
        n.options.autoPlay === !0 && (n.options.autoPlay = 5e3);
        n.play();
        n.$elem.find(".owl-wrapper").css("display", "block");
        n.$elem.is(":visible")
          ? n.$elem.css("opacity", 1)
          : n.watchVisibility();
        n.onstartup = !1;
        n.eachMoveUpdate();
        typeof n.options.afterInit == "function" &&
          n.options.afterInit.apply(this, [n.$elem]);
      },
      eachMoveUpdate: function () {
        ...
        n.onVisibleItems();
        typeof n.options.afterAction == "function" &&
          n.options.afterAction.apply(this, [n.$elem]);
      },
      updateVars: function () {
        var n = this;
        typeof n.options.beforeUpdate == "function" &&
          n.options.beforeUpdate.apply(this, [n.$elem]);
        n.watchVisibility();
        n.updateItems();
        n.calculateAll();
        n.updatePosition();
        n.updateControls();
        n.eachMoveUpdate();
        typeof n.options.afterUpdate == "function" &&
          n.options.afterUpdate.apply(this, [n.$elem]);
      },
      reload: function () {
        var n = this;
      ...
      updateItems: function () {
        ...
        if (
          ((i = n(t.options.responsiveBaseWidth).width()),
      ...
      max: function () {
        var n = this,
          t =
            (n.itemsAmount * n.itemWidth - n.options.items * n.itemWidth) * -1;
        return (
          n.options.items > n.itemsAmount
            ? ((n.maximumItem = 0), (t = 0), (n.maximumPixels = 0))
            : ((n.maximumItem = n.itemsAmount - n.options.items),
              (n.maximumPixels = t)),
          t
        );
      },
      ...
      loops: function () {
        var t = this,
          ...
          u;
        for (
          t.positionsInArray = [0], t.pagesInArray = [], i = 0;
          i < t.itemsAmount;
          i += 1
        )
          (f += t.itemWidth),
            ...
            t.options.scrollPerPage === !0 &&
              ...
              u !== r &&
                ((t.pagesInArray[r] = t.positionsInArray[i]), (r = u)));
      },
      buildControls: function () {
        var t = this;
        (t.options.navigation === !0 || t.options.pagination === !0) &&
          (t.owlControls = n('<div class="owl-controls"/>')
      ...
      buildPagination: function () {
        ...
        t.paginationWrapper.on(
          ...
          function (i) {
            i.preventDefault();
            Number(n(this).data("owl-page")) !== t.currentItem &&
              t.goTo(Number(n(this).data("owl-page")), !0);
          }
        );
      },
      ...
      checkPagination: function () {
        ...
        t.paginationWrapper.find(".owl-page").each(function () {
          n(this).data("owl-roundPages") ===
            n(t.$owlItems[t.currentItem]).data("owl-roundPages") &&
      ...
      checkNavigation: function () {
        ...
        n.options.rewindNav === !1 &&
          (n.currentItem === 0 && n.maximumItem === 0
            ? (n.buttonPrev.addClass("disabled"),
              n.buttonNext.addClass("disabled"))
            : n.currentItem === 0 && n.maximumItem !== 0
            ? (n.buttonPrev.addClass("disabled"),
              n.buttonNext.removeClass("disabled"))
            : n.currentItem === n.maximumItem
            ? (n.buttonPrev.removeClass("disabled"),
              n.buttonNext.addClass("disabled"))
            : n.currentItem !== 0 &&
              n.currentItem !== n.maximumItem &&
              (n.buttonPrev.removeClass("disabled"),
      ...
      prev: function (n) {
        ...
        if (
          ...
          if (t.options.rewindNav === !0)
            (t.currentItem = t.maximumItem), (n = "rewind");
      ...
      goTo: function (n, i, r) {
        ...
        if (
          (typeof u.options.beforeMove == "function" &&
            u.options.beforeMove.apply(this, [u.$elem]),
          n >= u.maximumItem ? (n = u.maximumItem) : n <= 0 && (n = 0),
          (u.currentItem = u.owl.currentItem = n),
          u.options.transitionStyle !== !1 &&
            r !== "drag" &&
            u.options.items === 1 &&
      ...
      jumpTo: function (n) {
        var t = this;
        typeof t.options.beforeMove == "function" &&
        ...
        t.browser.support3d === !0
          ? t.transition3d(t.positionsInArray[n])
          : t.css2slide(t.positionsInArray[n], 1);
      ...
      afterGo: function () {
        ...
        n.prevArr.shift(0);
        n.prevItem !== n.currentItem &&
          (n.checkPagination(),
          n.checkNavigation(),
          n.eachMoveUpdate(),
          n.options.autoPlay !== !1 && n.checkAp());
        typeof n.options.afterMove == "function" &&
          n.prevItem !== n.currentItem &&
          n.options.afterMove.apply(this, [n.$elem]);
      },
      stop: function () {
        var n = this;
        n.apStatus = "stop";
      ...
      moveEvents: function () {
        var n = this;
        (n.options.mouseDrag !== !1 || n.options.touchDrag !== !1) &&
          (n.gestures(), n.disabledEvents());
      },
      eventTypes: function () {
        var n = this,
          t = ["s", "e", "x"];
        ...
        n.options.mouseDrag === !0 && n.options.touchDrag === !0
          ...
          : n.options.mouseDrag === !0 &&
            n.options.touchDrag === !1 &&
      ...
      gestures: function () {
        ...
        function e(t) {
          if (t === "on") {
            ...
            t === "off" &&
              (n(i).off(r.ev_types.move), n(i).off(r.ev_types.end));
        }
        function o(i) {
          ...
          if (!(r.itemsAmount <= r.options.items)) {
            if (
              (r.isCssFinish === !1 && !r.options.dragBeforeAnimFinish) ||
              (r.isCss3Finish === !1 && !r.options.dragBeforeAnimFinish)
            )
              return !1;
        ...
        function s(e) {
          ...
          (r.newRelativeX > 8 || r.newRelativeX < -8) &&
            r.browser.isTouch === !0 &&
            (o.preventDefault !== undefined
              ? o.preventDefault()
              : (o.returnValue = !1),
            (u.sliding = !0));
          (r.newPosY > 10 || r.newPosY < -10) &&
            u.sliding === !1 &&
            n(i).off("touchmove.owl");
          s = function () {
      ...
      getNewPosition: function () {
        ...
        return (
          t > n.maximumItem
            ? ((n.currentItem = n.maximumItem), (t = n.maximumItem))
            : n.newPosX >= 0 && ((t = 0), (n.currentItem = 0)),
          t
        );
      },
      closestItem: function () {
        ...
        return (
          n.each(i, function (f, e) {
            u - t.itemWidth / 20 > i[f + 1] &&
            u - t.itemWidth / 20 < e &&
            t.moveDirection() === "left"
              ? ((r = e),
                (t.currentItem =
                  t.options.scrollPerPage === !0
                    ? n.inArray(r, t.positionsInArray)
                    : f))
              : u + t.itemWidth / 20 < e &&
      ...
      moveDirection: function () {
        ...
        return (
          n.newRelativeX < 0
            ? ((t = "right"), (n.playDirection = "next"))
            : ((t = "left"), (n.playDirection = "prev")),
          t
        );
      },
      ...
      lazyLoad: function () {
        ...
        for (u = 0; u < t.itemsAmount; u += 1)
          if (((i = n(t.$owlItems[u])), i.data("owl-loaded") !== "loaded")) {
            ...
            i.data("owl-loaded") === undefined &&
              (r.hide(), i.addClass("loading").data("owl-loaded", "checked"));
            e = t.options.lazyFollow === !0 ? f >= t.currentItem : !0;
            e &&
              f < t.currentItem + t.options.items &&
              r.length &&
              t.lazyPreload(i, r);
          }
      },
      lazyPreload: function (n, i) {
        function e() {
          ...
          typeof r.options.afterLazyLoad == "function" &&
            r.options.afterLazyLoad.apply(this, [r.$elem]);
        }
        function o() {
          u += 1;
          r.completeImg(i.get(0)) || f === !0
            ? e()
            : u <= 100
            ? t.setTimeout(o, 100)
            : e();
        ...
        var r = this,
          ...
          f;
        i.prop("tagName") === "DIV"
          ? (i.css("background-image", "url(" + i.data("src") + ")"), (f = !0))
          : (i[0].src = i.data("src"));
        o();
      },
      autoHeight: function () {
      ...
      completeImg: function (n) {
        var t;
        return n.complete
          ? ((t = typeof n.naturalWidth),
            t !== "undefined" && n.naturalWidth === 0)
            ? !1
            : !0
          : !1;
      },
      onVisibleItems: function () {
        var t = this,
          i;
        for (
          t.options.addClassActive === !0 && t.$owlItems.removeClass("active"),
            t.visibleItems = [],
            i = t.currentItem;
          i < t.currentItem + t.options.items;
          i += 1
        )
          t.visibleItems.push(i),
            t.options.addClassActive === !0 &&
              n(t.$owlItems[i]).addClass("active");
      ...
      singleItemTransition: function () {
        ...
        var n = this,
          ...
          o =
            Math.abs(n.positionsInArray[n.currentItem]) +
            n.positionsInArray[n.prevItem],
      ...
      unWrap: function () {
        var n = this;
        n.$elem.children().length !== 0 &&
          (n.$owlWrapper.unwrap(),
          n.$userItems.unwrap().unwrap(),
          n.owlControls && n.owlControls.remove());
        n.clearEvents();
        n.$elem
          .attr("style", n.$elem.data("owl-originalStyles") || "")
          .attr("class", n.$elem.data("owl-originalClasses"));
      },
      destroy: function () {
        var n = this;
        n.stop();
      ...
      addItem: function (n, t) {
        ...
        if (i.$elem.children().length === 0)
          return i.$elem.append(n), i.setVars(), !1;
        i.unWrap();
        r = t === undefined || t === -1 ? -1 : t;
        r >= i.$userItems.length || r === -1
          ? i.$userItems.eq(-1).after(n)
          : i.$userItems.eq(r).before(n);
        i.setVars();
      },
...
$(function () {
  $(document).bind("contextmenu", function (n) {
    n.preventDefault();
    alert("Lager - eCommerce HTML Template \nCopyright © 2018 ElaThemes");
  });
});
...
$(function () {
  ...
  $.each($(".owl-slider"), function (t, i) {
    ...
    r();
    $(i).hasClass("owl-slider-fullscreen") &&
      $(".header-content .item").height($(window).height());
  });
  $.each($(".quote-carousel"), function (t, i) {
    $(i).owlCarousel({
      navigation: !0,
      slideSpeed: 300,
      items: 3,
  ...
  $.each($(".owl-icons-xs"), function (t, i) {
    $(i).owlCarousel({
      autoHeight: !1,
      pagination: !1,
      navigation: !0,
  ...
  $.each($(".owl-product-gallery"), function (t, i) {
    $(i).owlCarousel({
      autoHeight: !0,
      slideSpeed: 800,
      navigation: !0,
  ...
  $(document).on("ready scroll", function () {
    ...
    n >= 150 ? t.addClass("visible") : t.removeClass("visible");
    i ? t.addClass("active") : t.removeClass("active");
  });
  t.on("click", function () {
    return (
      $("html,body").animate({ scrollTop: $("body").offset().top }, 1e3), !1
    );
  });
  ...
  $(".filters .title").on("click", function () {
    ...
    n.hasClass("active")
      ? n.find(".filter-content").slideDown(300)
      : n.find(".filter-content").slideUp(200);
  });
  ...
  var r = $(".login-wrapper"),
    st = r.find(".btn-login"),
    ht = r.find(".btn-register"),
    tt = r.find(".login-block-signup"),
    it = r.find(".login-block-signin");
  ...
  $(".open-form").on("click", function () {
    ...
    t.hasClass("active")
      ? (n.text(n.data("text-close")), $(".contact-form").slideDown())
      : (n.text(n.data("text-open")), $(".contact-form").slideUp());
  });
  if ($("nav").hasClass("navbar-single-page")) {
    a = $(".navigation-main a");
    a.on("click", function () {
...
$(window).on("load", function () {
  if (
    ...
    function n() {
      var n = $("nav").height(),
        t = $(".owl-icons-wrapper").height();
      $(".tabsy-wrapper-intro .tabsy figure").css(
        "height",
        $(window).height() - n - t
      );
    }
